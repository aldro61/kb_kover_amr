...
function kover_amr(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.predict_amr_phenotype = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kover_amr.predict_amr_phenotype",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kover_amr.status",
